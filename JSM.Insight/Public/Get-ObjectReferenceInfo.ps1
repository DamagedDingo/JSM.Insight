...
function Get-ObjectReferenceInfo {
    [CmdletBinding()]
    param (
        [string]$ID,
        [String]$Version = "1",
    ...
    process {
        $Request = [System.UriBuilder]"https://api.atlassian.com/jsm/insight/workspace/$InsightWorkstationID/v$Version/object/$id/referenceinfo"
    }
